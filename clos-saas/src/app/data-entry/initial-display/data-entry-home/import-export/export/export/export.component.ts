...
import { DownloadDataService } from 'src/app/admin/components/users/services/download-data.service';
...
export class ExportComponent implements OnInit {
  ...
  currentFolderPath: string = '/apps/los/batch_export/';
  ...
  downloadFolder(file: DirectoryModel) {
    ...
    file.path = '/apps/los/batch_export';
