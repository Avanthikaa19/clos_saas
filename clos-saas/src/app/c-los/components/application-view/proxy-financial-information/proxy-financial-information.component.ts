...
import { ApplicationDetails, ProxyFinancialInformation, ShareHolders, Statement, Suppliers } from 'src/app/c-los/models/clos';
...
@Component({
  selector: 'app-proxy-financial-information',
  templateUrl: './proxy-financial-information.component.html',
  styleUrls: ['./proxy-financial-information.component.scss']
})
export class ProxyFinancialInformationComponent implements OnInit {
        ...
        if (Array.isArray(responseData) && responseData.length > 0) {
          ...
          for (const newData of responseData) {
            ...
            if (existingDataIndex !== -1) {
              ...
              console.log(this.proxyFinancialInformation, 'kjh')
