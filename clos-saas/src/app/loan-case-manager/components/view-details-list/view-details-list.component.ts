...
import { displayFields } from 'src/app/duplicate-checking/models/models';
...
@Component({
  selector: 'app-view-details-list',
  templateUrl: './view-details-list.component.html',
  styleUrls: ['./view-details-list.component.scss']
})
export class ViewDetailsListComponent implements OnInit {
