...
@Component({
  selector: 'app-nth-tu-address-verification',
  templateUrl: './nth-tu-address-verification.component.html',
  styleUrls: ['./nth-tu-address-verification.component.scss']
})
export class NthTuAddressVerificationComponent implements OnInit {

  selectedNavigation: string ='Nth_TU_ADDRESS_VERIFICATION';
  ...
  downloadFile(res, format: string) {
    ...
    anchor.download = `Nth-TU-Address Verification${latest_date}.${format}`;
    anchor.href = url;
    anchor.click();
  }
