...
@Component({
  selector: 'app-tu-stage',
  templateUrl: './tu-stage.component.html',
  styleUrls: ['./tu-stage.component.scss']
})
export class TuStageComponent implements OnInit {

  selectedNavigation: string ='NTB_TU_ADDRESS_VERIFICATION';
  ...
  downloadFile(res, format: string) {
    ...
    anchor.download = `TU-Stage${latest_date}.${format}`;
    anchor.href = url;
    anchor.click();
  }
