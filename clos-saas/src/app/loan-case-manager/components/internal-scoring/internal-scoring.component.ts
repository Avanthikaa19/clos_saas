...
@Component({
  selector: 'app-internal-scoring',
  templateUrl: './internal-scoring.component.html',
  styleUrls: ['./internal-scoring.component.scss'],
  //encapsulation: ViewEncapsulation.None
})
export class InternalScoringComponent implements OnInit {
  ...
  finsurgeIds: any[] = [];
  isView:boolean=true;
  selectedNavigation: string ='KYC_APPROVED';
...
// GET DATE FIELDS
  ...
  downloadFile(res, format: string) {
    ...
    anchor.download = `DuplicateChecking${latest_date}.${format}`;
    anchor.href = url;
    anchor.click();
  }
