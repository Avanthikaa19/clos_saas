...
@Component({
  selector: 'app-nth-camm-address',
  templateUrl: './nth-camm-address.component.html',
  styleUrls: ['./nth-camm-address.component.scss']
})
export class NthCammAddressComponent implements OnInit {

  selectedNavigation: string ='Nth_CAMM_ADDRESS_VERIFICATION';
  ...
  downloadFile(res, format: string) {
    ...
    anchor.download = `Nth-CAMM-AddressVerification${latest_date}.${format}`;
    anchor.href = url;
    anchor.click();
  }
