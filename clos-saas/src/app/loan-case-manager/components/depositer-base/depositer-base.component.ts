...
import { ViewDetailsComponent } from 'src/app/duplicate-checking/components/view-details/view-details.component';
...
import { ViewDetailsListComponent } from '../view-details-list/view-details-list.component';

@Component({
  selector: 'app-depositer-base',
  templateUrl: './depositer-base.component.html',
  styleUrls: ['./depositer-base.component.scss']
})
export class DepositerBaseComponent implements OnInit {
  ...
  getExtraColumns() {
    if (this.selectedTabName === 'verificationQueue') {
      ...
      this.extraColumns = [
        ...
        {
          fieldName: "$document_preview_deposter_other",
          displayName: "Document Preview",
          lockColumn: false,
          columnDisable: true,
          searchText: [],
