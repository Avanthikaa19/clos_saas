...
@Component({
  selector: 'app-depositerbase-viewdetails-popup',
  templateUrl: './depositerbase-viewdetails-popup.component.html',
  styleUrls: ['./depositerbase-viewdetails-popup.component.scss']
})
export class DepositerbaseViewdetailsPopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DepositerbaseViewdetailsPopupComponent>,
  ) { 
