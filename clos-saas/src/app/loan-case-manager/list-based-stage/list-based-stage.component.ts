...
@Component({
  selector: 'app-list-based-stage',
  templateUrl: './list-based-stage.component.html',
  styleUrls: ['./list-based-stage.component.scss']
})
export class ListBasedStageComponent implements OnInit {
