...
@Component({
  selector: 'app-underwriter-queue-declined',
  templateUrl: './underwriter-queue-declined.component.html',
  styleUrls: ['./underwriter-queue-declined.component.scss']
})
export class UnderwriterQueueDeclinedComponent implements OnInit {

  pageNum: number = 0;
  pageSize: number = 15;
  verificationStatus: string = 'DECLINED';
