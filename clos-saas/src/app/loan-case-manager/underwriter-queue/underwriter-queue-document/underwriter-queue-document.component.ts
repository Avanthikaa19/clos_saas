...
@Component({
  selector: 'app-underwriter-queue-document',
  templateUrl: './underwriter-queue-document.component.html',
  styleUrls: ['./underwriter-queue-document.component.scss']
})
export class UnderwriterQueueDocumentComponent implements OnInit {

  pageNum: number = 0;
  pageSize: number = 15;
  verificationStatus: string = 'REQUESTED DOCUMENT';
  ...
  // underwriter Request Document
  getRequestedDocument(pageNav?: PageEvent) {
    this.loading = true;
    if (pageNav) {
