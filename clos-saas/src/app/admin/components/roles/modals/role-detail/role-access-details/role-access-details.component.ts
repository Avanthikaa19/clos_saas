...
@Component({
  selector: 'app-role-access-details',
  templateUrl: './role-access-details.component.html',
  styleUrls: ['./role-access-details.component.scss'],
  animations: [fadeInOut]
})
export class RoleAccessDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<RoleAccessDetailsComponent>,
  ...
  selectInTemplatesList(template: AccessTemplate, defaultCheck: AccessTemplate): boolean {
    if (template.id == defaultCheck.id) {
